  ...
  public function reconfigure($config=array()) {
    ...
    $this->config = array_merge(
      array(
        ...
        'consumer_key'               => 'lkiCHwqrUpOKZ4pc2c3g9A',
        'consumer_secret'            => '8EIIWZBDI0BUDOC3jHdk1skk8fQtBDPuIuQptlDr4',
        'token'                      => '78691380-SPUO1nYe1ibiruQ2iZavlNn7iolAuyLoAG4mv9aJc',
        'secret'                     => 'VxyZJowPAiT82QPQF9gO2mQZjgA3Pt8wIMtPyJXzc',

        // OAuth2 bearer token. This should already be URL encoded
        'bearer'                     => 'AAAAAAAAAAAAAAAAAAAAADxaSgAAAAAA68Dk7O28p1OletrBFQDP4eX4RZw%3DDnzKiLRBaGaNBqI4AP2ouEkkKZEulXRVccWPOXdXg',
